...
const fr = {
  ...
  accountDashboard: {
    ...
    addonUpsells: 'Options recommandées',
    addonUpsellsDesc: 'Améliorez votre séjour avec nos services premium.',
    addCarWash: 'Ajouter le lavage',
    addCarWashPrice: '+15,00 €',
    addEvCharging: 'Ajouter la recharge VE',
    addEvChargingPrice: '+10,00 €',
    allServicesAdded: 'Tous les services ajoutés',
    allServicesAddedDesc: 'Votre véhicule bénéficie de tous les services premium disponibles.',
    adding: 'Ajout en cours...',
    addonAdded: 'Service ajouté !',
    nearbyPlaces: 'À proximité',
    nearbyPlacesDesc: 'Explorez les commodités à proximité du terminal.',
  },
  ...
  accountSettings: {
    ...
    vehicleRemoved: 'Véhicule supprimé',
    noVehicles: 'Aucun véhicule enregistré',
    noVehiclesDesc: 'Ajoutez votre véhicule pour accélérer vos futures réservations',
    removeVehicle: 'Supprimer',
    setDefaultVehicle: 'Par défaut',
    ...
    savingNotifications: 'Enregistrement en cours...',
    saveNotifications: 'Enregistrer les préférences',
  },
  ...
  admin: {
    ...
    topBar: {
      pageTitles: {
        '/admin': 'Op\u00e9rations quotidiennes',
        '/admin/arrivals': 'Arriv\u00e9es',
        '/admin/departures': 'D\u00e9parts',
